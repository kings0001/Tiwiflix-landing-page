...
>
  ...
  Your browser does not support the video tag.
      ...
      <div className="relative z-10 flex flex-col items-center">
        <h1 className="text-5xl sm:text-6xl md:text-6xl text-[#FFF] max-w-sm md:max-w-5xl font-semibold leading-tight">
  The Multi-chain Platform Where{" "}
  <span className="text-brand-yellow">Creators Rule</span>
</h1>


        <p className="mt-6 text-2xl sm:text-lg text-[#BCBCBC] max-w-sm md:max-w-md">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
         <button
  className="flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-3 
