...
const UserExperience: FC = () => {
  return (
    <section className="bg-[#080C17] min-h-screen px-0 sm:px-6 md:px-20 py-2 md:py-8">
      <div className="max-w-6xl mx-auto rounded-xl p-6 sm:p-8">
        {/* Label */}
        <div className="mx-auto text-center mb-12">
          <div className="inline-flex items-center gap-1 bg-[#271600] text-[#FFBC00] rounded-full px-4 py-3 mb-4 text-sm font-medium mx-auto sm:py-3 sm:text-sm">
            <Image
              src="/images/logo.svg"
              alt="logo"
              width={16}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="relative flex items-start bg-[#11172C] rounded-lg md:p-6 p-10 text-white text-sm">
              <Image
            ...
            {/* Card 2 */}
            <div className="flex items-start bg-gradient-to-r from-[#F9AC17] to-[#FF5E01] text-black rounded-lg md:p-6 p-10 text-sm font-medium">
              <Image
            ...
            <div className="relative flex items-start bg-[#11172C] rounded-t-lg md:p-6 p-10 text-white/90 text-sm">
...
<div className="absolute -bottom-6 left-0 w-full h-[28px] bg-gradient-to-b from-[#11172C] via-[#080c179c] to-transparent" />
          ...
          <div className="flex justify-center">
            <Image
              ...
              width={617}
              height={823}
              className="w-full md:max-w-md h-auto rounded-lg"
            />
          </div>
        </div>
      </div>
