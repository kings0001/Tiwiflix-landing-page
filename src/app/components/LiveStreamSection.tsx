  ...
  return (
    <section className="w-full bg-[#0E1321] py-16 px-6 flex flex-col items-center text-center">
      ...
      <p className="text-gray-300 max-w-2xl mb-10">
        ...
        powerful streaming tools with chat, tipping, and fun interactive features.
      </p>
        ...
        <div className="relative rounded-xl w-[560px] h-[315px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full px-4 py-2 bg-[#1a1f35]/90 flex justify-between items-center gap-4">
            ...
            {/* <div className="flex-1 h-1 bg-gray-600 rounded-full relative"> */}
              {/* <div className="absolute left-0 top-0 h-1 w-1/2 bg-gradient-to-r from-[#F9AC17] to-[#FF5E01] rounded-full" /> */}
            {/* </div> */}
      ...
      {/* Button */}
      <button className="mt-10 px-6 py-2 rounded-lg text-white font-semibold bg-[linear-gradient(117deg,#F9AC17_0%,#FF5E01_100%)] hover:opacity-90 transition">
        Host a Live Stream
      </button>
    </section>
  );
